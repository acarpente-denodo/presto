        ...
        implements ErrorCodeSupplier
{
    ...
    // The commit was rejected because another writer changed the table concurrently. Nothing was
    // written, so the statement can be executed again against the new state of the table.
