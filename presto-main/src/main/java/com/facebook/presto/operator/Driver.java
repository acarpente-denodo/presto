        ...
        implements Closeable
{
    ...
    private final Optional<MergeIntoOperator> mergeOperator;
    ...
    private Driver(DriverContext driverContext, List<Operator> operators)
    {
        ...
        Optional<MergeIntoOperator> mergeOperator = Optional.empty();
        for (Operator operator : operators) {
            ...
            else if (operator instanceof MergeIntoOperator) {
                checkArgument(!mergeOperator.isPresent(), "There must be at most one MergeIntoOperator");
                mergeOperator = Optional.of((MergeIntoOperator) operator);
            }
        }
