...
public class HandleResolver
{
    ...
    public String getId(ConnectorMergeHandle mergeHandle)
    {
    ...
    public Class<? extends ConnectorMergeHandle> getMergeHandleClass(String id)
    {
    ...
    private static class MaterializedHandleResolver
    {
        ...
        private final Optional<Class<? extends ConnectorMergeHandle>> mergeHandle;
        ...
        public MaterializedHandleResolver(ConnectorHandleResolver resolver)
        {
            ...
            mergeHandle = getHandleClass(resolver::getMergetHandleClass);
        ...
        public Optional<Class<? extends ConnectorMergeHandle>> getMergeHandleClass()
        {
            return mergeHandle;
        }
        ...
        public boolean equals(Object o)
        {
            ...
            return Objects.equals(tableHandle, that.tableHandle) &&
                    ...
                    Objects.equals(mergeHandle, that.mergeHandle) &&
        ...
        public int hashCode()
        {
            return Objects.hash(tableHandle, layoutHandle, columnHandle, split, indexHandle, outputTableHandle, insertTableHandle,
                    mergeHandle, partitioningHandle, transactionHandle, metadataUpdateHandle);
        }
    }
