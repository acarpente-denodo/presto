...
import com.facebook.presto.sql.planner.plan.TableWriterNode.MergeTarget;
...
// TODO: Clase copiade Trino y adaptada a Presto. Revisar si es necesario hacer más cambios.
@Immutable
        ...
        extends InternalPlanNode
{
    ...
    {
        super(sourceLocation, id, statsEquivalentPlanNode); // TODO: Revisar si estos parámetros son los correctos.
    ...
    // TODO: Este método existe en Trino y puede que no sea necesario en Presto (al menos por ahora).
...
//    @Override
//    public List<VariableReferenceExpression> getOutputSymbols()
//    {
//        return outputs;
//    }
