...
public interface ConnectorMergeSink
{
    ...
    // TODO: Buscar los usos de los siguientes dos enumerados en Trino y comprobar si tiene senido migrarlos a Presto.
    /**
     * Represents a new version of an updated row, to be inserted, when using
     * {@link com.facebook.presto.spi.connector.RowChangeParadigm#DELETE_ROW_AND_INSERT_ROW}.
     */
