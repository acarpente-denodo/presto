        ...
        implements Block
{
    ...
    public static List<Block> getRowFieldsFromBlock(Block block)
    {
        ...
        if (block instanceof RunLengthEncodedBlock) {
            ...
            return Arrays.stream(rowBlock.fieldBlocks)// TODO: Trino tiene un campo llamado "fieldBlocksList" y se evita estar creando la lista de cada vez.
        ...
        if (block instanceof RowBlock) {
            return Arrays.asList(((RowBlock) block).fieldBlocks); // TODO: Trino tiene un campo llamado "fieldBlocksList" y se evita estar creando la lista de cada vez.
        }
